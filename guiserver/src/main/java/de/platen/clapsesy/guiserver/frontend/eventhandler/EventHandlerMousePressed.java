...
public class EventHandlerMousePressed extends EventHandlerMouse {
    ...
    public EventHandlerMousePressed(final GuiElement guiElement,
            final EventSenderMousePressed eventSenderMousePressed) {
        super(guiElement);
        eventHandler = event -> {
            try {
                ...
                if (!guiElement.isInactive()) {
                    ...
                    if (hasToSend) {
                        eventSenderMousePressed.sendEvent(guiElement.getElementId().get(), xRelative, yRelative,
